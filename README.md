...
Public deployment: the same image on Render's free tier (`render.yaml`) with the dashboard on Vercel (`frontend/vercel.json`); steps in [docs/backend/RUNNING.md](docs/backend/RUNNING.md), section 9.
