...
export default function App() {
  ...
  return (
    <div className="min-h-screen relative flex flex-col font-sans selection:bg-orange-500 selection:text-black">
      ...
      {/* 6. Footer */}
      <footer className="w-full border-t border-white/8 bg-[#090a0f]/90 backdrop-blur-md py-4 px-6 text-center text-xs font-mono text-slate-500">
