                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="py-2.5 px-3">
                          <div className="flex flex-col">
                            <span className={limitFraction >= 1 ? 'text-rose-400 font-bold' : (limitFraction < 0.45 ? 'text-emerald-400 font-medium' : 'text-slate-200')}>
                        ...
                        <td className="py-2.5 px-3">
                          <div className="flex flex-col">
                            <span
                              className={`
                                ${record.forecast?.predicted_to_cross_limit ? 'text-rose-400 font-bold' : (record.recommendation === 'ACCEPT' ? 'text-emerald-400' : 'text-slate-300')}
                              `}
                            >
            ...
            <div>
              ...
              <div className="p-2.5 rounded-lg bg-white/[0.015] border border-white/[0.04]">
                ...
                <div className="mt-3 pt-2 border-t border-white/[0.04] flex flex-wrap items-center justify-between text-[9px] font-mono text-slate-400 gap-1.5">
                  <div className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded bg-emerald-500/25 border border-emerald-500/40" />
                    <span className="text-emerald-300">&lt;0.05 µA (Good)</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded bg-emerald-500/10 border border-emerald-500/20" />
                    <span>0.10 µA</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded bg-yellow-500/20 border border-yellow-500/30" />
                    <span>0.15 µA</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded bg-amber-500/30 border border-amber-500/40" />
                    <span>0.20 µA</span>
                  </div>
                  <div className="flex items-center gap-1">
                    <span className="w-2 h-2 rounded bg-rose-500 shadow-[0_0_6px_#ef4444]" />
                    <span className="text-rose-300 font-bold">≥0.25 µA (Error)</span>
                  </div>
                </div>
              </div>
            </div>
